...
const ChatBot = ({open, openT}) => {
  ...
  return (
    <div className={`bg-gray-300 p-10 ${!openT || !open ? "hidden" : "block"} sm:block`}>
        <div className="">
          <div className="">
              <h1 className="font-bold mb-3 text-xl font-sans">AI-Project V. Beta</h1>
              <hr className=" border-gray-900 mb-4" />
          </div>
          <div className="flex flex-col h-96 p-2 pt-4 mb-4 gap-2 rounded-md shadow-md text-justify hover:bg-gray-400/25 hover:border-gray-200 overflow-y-scroll no-scrollbar">
        ...
        <div className="flex flex-col ">
            ...
            >
              ...
              ></textarea>
              <Button  className="mb-14 bg-blue-gray-300 h-16 ml-2">
                {/* <svg
